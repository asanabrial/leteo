...
//!
//! Some of them do read prose, and that is a deliberate reversal of what this
//! header used to say. (How many is not written here. This is the file whose own
//! doctrine is that a count in a sentence is a second copy of the list it
//! counts.) Comments in `ci.yml`, `tools/README.md` and `src/cloud/`
